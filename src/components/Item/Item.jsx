          ...
          <div class="nav__categotiya-wrapper">
            <div class="nav_categoriya__chit">
              <ul class="nav__categoriya-link">
                ...
                <li><a href="https://m-mcsim7.github.io/training-shop/">Women's tracksuit Q109</a></li>
              </ul>
            ...
            <div class="item__all">
              ...
              <div class="item__info">
                ...
                <div class="item__info-conditions">
                  <p><img src={Shipping} alt="icon" />Shipping & Delivery</p>
                  <p><img src={Returns & Exchnges} alt="icon" />Returns & Exchanges</p>
                  <p><img src={Ask} alt="icon" />Ask a question</p>
                </div>
                <div class="item__info-checkout">
                  ...
                  <div class="item__info-reviews">
                    ...
                    <div class="item__info-score-reviews">
                      ...
                      <p>
                        <img src="./img/icons/review.svg" alt="icon" /> Write a
                        review
                      </p>
                    </div>
